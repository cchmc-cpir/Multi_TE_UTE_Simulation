function [p,ellipse]=phantom3d_IRS(varargin)
...
e = [];
defaults = {'shepp-logan', 'irs-fakemouse', 'irs-undersampling1', 'modified shepp-logan', 'yu-ye-wang'};
...
for i=1:nargin
   if ischar(varargin{i})         % Look for a default phantom
      ...
      case 'irs-fakemouse'
         e = irs_fakemouse;
      case 'irs-undersampling1'
         e = irs_undersampling1;
      case 'shepp-logan'
         e = shepp_logan;
...
function e = irs_fakemouse
%
%   This head phantom is the same as the Shepp-Logan except 
%   the intensities are changed to yield higher contrast in
%   the image.  Taken from Toft, 199-200. In addition,
%   the size of the phantom is reduced and additional 
%   ellipses are added to more closely represent mouse lung images
%      
%         A      a     b     c     x0      y0      z0    phi  theta    psi
%        -----------------------------------------------------------------
e =    [  1  .5700  .780  .500      0       0       0      0      0      0
        -.8  .5424  .754  .490      0  -.0100       0      0      0      0
        -.2  .1000  .290  .170    .25   -.075       0    -18      0     10
        -.2  .1450  .390  .180   -.26       0       0     10      0     10
         .1  .1800  .220  .110      0     .35    -.03      0      0      0
         .5  .0100  .100  .100   -.30    .105       0      8      0      8
         .5  .0340  .036  .100   -.13   -.256       0      0      0      0
         .5  .0330  .026  .100   -.20   -.305       0      0      0      0
         .5  .0200  .050  .100     0    -.220       0      0     0     -60
         .5  .0300  .032  .100    .21   -.256       0      0      0      0
         .5  .0100  .075  .100    .28    .065       0     -8      0     -8
         .5  .0150  .050  .100    .01   -.250       0      0      0      60];
       
return;

function e = irs_undersampling1
%
%   This head phantom is the same as the Shepp-Logan except 
%   the intensities are changed to yield higher contrast in
%   the image.  Taken from Toft, 199-200. In addition,
